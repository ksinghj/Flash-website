  ...
  return (
    <>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <C2AButton className='px-14 py-3 my-10 text-2xl'>Try for free</C2AButton>
        <div className='hidden lg:flex flex-col justify-center items-center my-10'>
          <h6 className='mb-6 text-white'>Works great on mobile too:</h6>
          <Image src={QR} alt='QR code the app' width={300} />
        </div>
      </div>
    </>
  )
